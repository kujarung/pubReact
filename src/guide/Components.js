...
export default function Components() {
	...
	const imgList = [
		...
		},
		{
			id: 'xcvxcvfgdsvcb',
			imgPath: base3,
			content: 'At sdfdsleast 50 people burned to vxcvdeath in a buzxcvzxcs colvlision in Ghana',
		},
	];
	const horzList = [
		{
	...
	return (
		<div className="over-hidden">
			<section className="mt50 mb50 guide-border">
				...
				<div className="">
					<AnserBtn click={() => console.log('click')} btnTxt={'텍스트'} active={true} />
				</div>
			</section>
			...
			<section className="mb50 guide-border">
				...
				<div className="">
					<Barchart title={'75450'} percentList={[20, 30, 10, 50, 50, 100, 10]} />
				</div>
			</section>
