...
export default function SettingRepeat(props) {
  return (
    <div className="h-100vh">
      <StackHeader />
      <div className="content-scroll-container type2">
        <div className="bothSpace pt29 mb40">
          <h3 className="weight500 stack-content">복습주기 설정</h3>
        </div>
        ...
        <div className="bothSpace">
          ...
          <div className="shadow-box mb-small-30">
            <div className="repeact-con">
