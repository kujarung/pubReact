			...
			<div className="bothSpace mt29">
				<div className="level-info-con mb20">
					...
					<div className="">
						<h6 className="weight100 line-h26">
							레벨은 학습자님의 레벨이 아닌,
							<br />
							<span className="weight500">콘텐츠의 레벨을 의미</span>해요. 학습 우선순위로 <br />
				...
				<div className="level-info-con mb30">
					<div className="pos-rel mb20">
						<CircleProgress width={width > 330 ? '280' : '230'} percent={42} />
						{/* 원형 차트 설명 */}
					...
					<div className="">
						...
						<div className="">
							<h6 className="weight100 line-h26">
								...
								<span className="weight500">20%의 콘텐츠를 읽을 수 있음</span>을 의미해요.
								<br />
								<br />
								예를 들자면, 1레벨까지의 콘텐츠를 읽을 수 있다는 의미는 약 15%의 콘텐츠를 읽을 수
								있다는 의미에요. <br />
								그러므로 20레벨까지의 콘텐츠를 읽을 수 있는 것과 20%의 콘텐츠를 읽을 수 있다는 것은
								다른 의미죠. <br />
							</h6>
						</div>
					</div>
