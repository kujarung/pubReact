			...
			<div className="">
					...
					<a href="#">
						...
						<div className="event-content">
							<h6 className="weight500 mb11">
								이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목
							</h6>
							<div className="smallFont color-gray">2020.06.01(금) ~ 2020.06.30(토)</div>
						</div>
					</a>
				</div>
				...
				<div className="event-item-con">
					<a href="">
						...
						<div className="event-content">
							<h6 className="weight500 mb11">
								이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목
								이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목
								이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목
								이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목 이벤트 제목
								이벤트 제목 이벤트 제목
