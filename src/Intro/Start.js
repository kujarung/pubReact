				...
				<div className="card-bottom-txt">
					...
					<div className="">
						<h6 className="weight100 line-h26">
							...
							디지털 콘텐츠의 폭발적인 증가로
							<br />
							<span className="weight500">정보</span>의 격차는 더욱 심해지고 있죠.
							<br />
						</h6>
					</div>
				</div>
				...
				<div className="card-bottom-txt">
					...
					<div className="">
						<h6 className="weight100 line-h26">
							...
							<br />
							지금 바로 <span className="weight500">읽기 학습</span>을 시작할 수 있어요.
							<br />
							가장 빠르게 실력이 오르는 순서로
							<br />
				...
				<div className="card-bottom-txt">
					...
					<div className="">
						<h6 className="weight100 line-h26">
							...
							가 해결해줘요.
							<br />
							모든 학습 과정을 <span className="weight500">수치화</span>하고{' '}
							<span className="weight500">분석</span>해서
							<br />
		...
		<div className="h-100vh">
			<div className="card-container">
				...
				<div className="card-bottom-txt">
					...
					<div className="mb40">
						<h4 className="small fontAvenir line-h30 sm-small">
							Just get on a rocket ship
							<br />
							with <span className="primary-underline weight500">READING PERCENT!</span>
						</h4>
					</div>
					<div className="rest-icon mb11">
						<img src={icRest} alt="ic-rest" />
					...
					<div className="">
						<h6 className="weight100 line-h26">
							...
							<span className="weight500">생각</span>하고, <span className="weight500">성장</span>
							하는
							<br />
