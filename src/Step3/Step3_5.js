				...
				<div className="mb52">
					...
					<div className="tc">
						...
						<h5 className="weight500">
							단어리뷰 <span className="weight400 step-underline">Completed!</span>
						</h5>
					</div>
				</div>

				<div className="shadow-box pa30 mb37">
					<h5 className="line-h24 weight300 small">
						...
						<div className="d-flex x-eq y-center">
							<div className="">
								<span className="color-primary">뒤로가기</span>를 눌러 단어리뷰를 하거나{' '}
								<span className="color-primary">오른쪽 버튼</span>을 눌러 원문 리뷰를 해보세요
							</div>
							<button className="ml10 self-y-end">
								<div className="read-icon" style={{ backgroundImage: `URL(${ic_read})` }} />
							</button>
						</div>
					</h5>
				</div>
				...
				<div className="pl30 mb20">
					...
					<div className="mb20">
						<h5 className="weight300 line-h26 small">
							총점 <span className="color-primary">80점</span>이상 받으면 학습 단계를
							<br />
							완료할 수 있습니다!
							<br />
							준비되셨나요?
