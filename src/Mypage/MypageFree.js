			...
			<div className="mb32 pt2">
				...
				<div className="info-box-wrap bothSpace">
					<div className="info-box">
						...
						<a href="#">
							<p className="h7 color-primary primary-underline">이용권 구매하기</p>
						</a>
					</div>
					...
					<div className="info-box-wrap type2">
						<div className="info-box lock">
							...
							<div>
								...
								<h5 className="info-desc small color-bordergray">총 학습시간</h5>
							</div>
						</div>
						<div className="info-box lock">
							<div className="">
						...
						<div className="info-box lock">
							...
							<div>
								...
								<h5 className="info-desc small color-bordergray">현재 달성률</h5>
							</div>
						</div>
					</div>
				</div>
